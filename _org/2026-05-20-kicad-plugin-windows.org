...
[[/images/kicad-plugin-install-uv-win.png]]
...
[[/images/kicad-plugin-config-plugin-win.png]]

** 配置插件

安装完成后，打开 KiCad，在 PCB 编辑器的 *Tools* 菜单中找到并启动 *Kicad AI Assistant* 插件。

[[/images/kicad-plugin-open-plugin-win.png]]
...
[[/images/kicad-plugin-setting-interface-win.png]]
